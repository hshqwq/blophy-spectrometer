...
tools = {
    ...
    {name: 'eazy Tap', list: 'editETap', type: 'button'},
...
$(() => {
    ...
    $('#start').unbind('click').click(() => {
        ...
        $('*').show();
        $('body').empty();
        $('body').append(`<ul id="infoList"></ul><div id="ui"><div id="ui-info"></div><div id="ui-time"><input id="ui-time-time"type="number"min="-100"step="1"/><audio id="ui-time-audio"controls></audio></div><div id="ui-menu"><ul id="ui-menu-toolbar"page="main"></ul><div id="ui-menu-uiDispaly"class="ui-menu-button">淡化界面</div><div id="ui-menu-save"class="ui-menu-button">保存</div><div id="ui-menu-settings"class="ui-menu-button">设置</div></div><ul id="ui-display"><li id="ui-display-top"class="pdk canEdit">判定块上<input type="checkbox"checked></li><li id="ui-display-left"class="pdk canEdit">判定块左<input type="checkbox"checked></li><li id="ui-display-bottom"class="pdk canEdit">判定块下<input type="checkbox"checked></li><li id="ui-display-right"class="pdk canEdit">判定块右<input type="checkbox"checked></li><li id="ui-display-tap"class="note">Tap<input type="checkbox"checked></li><li id="ui-display-drag"class="note">Drag<input type="checkbox"checked></li><li id="ui-display-hold"class="note">Hold<input type="checkbox"checked></li><li id="ui-display-lineId"class="id">判定线/块ID<input type="checkbox"checked></li><li id="ui-display-noteId"class="id">note ID<input type="checkbox"checked></li><li id="ui-display-pointId"class="id">顶点ID<input type="checkbox"checked></li><li id="ui-display-textId"class="id">文本ID<input type="checkbox"checked></li><li id="ui-display-lines"class="list"><div>判定线/块s</div><ul></ul></li><li id="ui-display-notes"class="list"><div>notes</div><ul></ul></li></ul><div id="ui-edit"><iframe id="ui-edit-bezier"src="bezier.html"width="300"height="400"></iframe><div id="ui-edit-from"><div class="info info-type"><span class="info-form"><span class="info-name">动画类型</span><div class="info-input-radlist"><div>Note<input class="info-input-rad"type="radio"name="type"value="note"></div><div>判定线<input class="info-input-rad"type="radio"name="type"value="line"></div><div>判定框<input class="info-input-rad"type="radio"name="type"value="block"></div><div>文本(完善ing,过几日实装)<input class="info-input-rad"type="radio"name="type"value="text"disabled></div><div>顶点(完善ing,过几日实装)<input class="info-input-rad"type="radio"name="type"value="point"disabled></div></div></span></div><!--note--><div class="info info-note info-note-animation"><span class="info-form"><span class="info-name">动画</span><div class="info-input-radlist"><div>+<input class="info-input-rad"type="radio"name="noteAnimation"value="+"></div></div></span></div><div class="info info-note"><span class="info-form"><span class="info-name">note ID</span><input class="info-input-num"type="number"name="noteId"min="0"value="0"step="1"></span><span class="info-form"><span class="info-name">父级判定线ID</span><input class="info-input-num"type="number"name="noteLine"min="0"value="0"step="1"></span></div><div class="info info-note"><span class="info-form"><span class="info-name">起始X</span><input class="info-input-num"type="number"name="noteX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">endX</span><input class="info-input-num"type="number"name="noteEndX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">起始Y</span><input class="info-input-num"type="number"name="noteY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束Y</span><input class="info-input-num"type="number"name="noteEndY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">note类型(默认Tap)</span><div class="info-input-radlist"><div>Tap<input class="info-input-rad"type="radio"name="noteType"value="tap"></div><div>Easy Tap<input class="info-input-rad"type="radio"name="noteType"value="eTap"></div><div>Drag<input class="info-input-rad"type="radio"name="noteType"value="drag"></div><div>Hold<input class="info-input-rad"type="radio"name="noteType"value="hold"></div><div>Row(明天/后天实装)<!--(未经稳定性考验,出bug可能性较高)--><input class="info-input-rad"type="radio"name="noteType"value="row"></div><div>Touch(明天/后天实装)<!--(未经稳定性考验,出bug可能性较高)--><input class="info-input-rad"type="radio"name="noteType"value="touch"></div></div></span><span class="info-form"><span class="info-name">开始时间</span><input class="info-input-num"type="number"name="noteStartTime"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束时间</span><input class="info-input-num"type="number"name="noteEndTime"value="0"step="0.01"></span><span class="info-form"><span class="info-name">贝塞尔曲线动画</span><input class="info-input-che"type="checkbox"name="noteBezier"></span></div><div class="info info-note info-note-bezier"><span class="info-form"><span class="info-name">贝塞尔曲线参数X1</span><input class="info-input-num"type="number"name="noteBezier-x1"value="0"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数Y1</span><input class="info-input-num"type="number"name="noteBezier-y1"value="0"step="0.01"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数X2</span><input class="info-input-num"type="number"name="noteBezier-x2"value="0"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数Y2</span><input class="info-input-num"type="number"name="noteBezier-y2"value="0"step="0.01"></span></div><div class="info info-note info-note-type-hold"><span class="info-form"><span class="info-name">起始高度</span><input class="info-input-num"type="number"name="noteHeight"value="10"step="0.1"></span><span class="info-form"><span class="info-name">结束高度</span><input class="info-input-num"type="number"name="noteEndHeight"value="10"step="0.1"></span></div><!--line--><div class="info info-line info-line-animation"><span class="info-form"><span class="info-name">动画</span><div class="info-input-radlist"><div>+<input class="info-input-rad"type="radio"name="lineAnimation"value="+"></div></div></span></div><div class="info info-line"><span class="info-form"><span class="info-name">判定线ID</span><input class="info-input-num"type="number"name="lineId"min="0"value="0"step="1"></span></div><div class="info info-line"><span class="info-form"><span class="info-name">起始X</span><input class="info-input-num"type="number"name="lineX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束X</span><input class="info-input-num"type="number"name="lineEndX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">起始Y</span><input class="info-input-num"type="number"name="lineY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束Y</span><input class="info-input-num"type="number"name="lineEndY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">起始角度(°)</span><input class="info-input-num"type="number"name="lineEulerAngle"value="0"step="0.1"></span><span class="info-form"><span class="info-name">结束角度(°)</span><input class="info-input-num"type="number"name="lineEndEulerAngle"value="0"step="0.1"></span><span class="info-form"><span class="info-name">不透明度(0最低,1最高)</span><input class="info-input-num"type="number"name="lineAlpha"value="1"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">结束不透明度(0最低,1最高)</span><input class="info-input-num"type="number"name="lineEndAlpha"value="1"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">起始边长</span><input class="info-input-num"type="number"name="lineWidth"value="0"step="0.1"></span><span class="info-form"><span class="info-name">结束边长</span><input class="info-input-num"type="number"name="lineEndWidth"value="0"step="0.1"></span><span class="info-form"><span class="info-name">起始颜色</span><input class="info-input-col"type="color"name="lineColor"value="rgb(255,255,255)"></span><span class="info-form"><span class="info-name">结束颜色</span><input class="info-input-col"type="color"name="lineEndColor"value="rgb(255,255,255)"></span><span class="info-form"><span class="info-name">开始时间</span><input class="info-input-num"type="number"name="lineStartTime"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束时间</span><input class="info-input-num"type="number"name="lineEndTime"value="0"step="0.01"></span><span class="info-form"><span class="info-name">贝塞尔曲线动画</span><input class="info-input-che"type="checkbox"name="lineBezier"></span></div><div class="info info-line info-line-bezier"><span class="info-form"><span class="info-name">贝塞尔曲线参数X1</span><input class="info-input-num"type="number"name="lineBezier-x1"value="0"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数Y1</span><input class="info-input-num"type="number"name="lineBezier-y1"value="0"step="0.01"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数X2</span><input class="info-input-num"type="number"name="lineBezier-x2"value="0"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数Y2</span><input class="info-input-num"type="number"name="lineBezier-y2"value="0"step="0.01"></span></div><!--block--><div class="info info-block info-block-animation"><span class="info-form"><span class="info-name">动画</span><div class="info-input-radlist"><div>+<input class="info-input-rad"type="radio"name="blockAnimation"value="+"></div></div></span></div><div class="info info-block"><span class="info-form"><span class="info-name">判定框ID</span><input class="info-input-num"type="number"name="blockId"min="0"value="0"step="1"></span></div><div class="info info-block"><span class="info-form"><span class="info-name">起始X</span><input class="info-input-num"type="number"name="blockX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束X</span><input class="info-input-num"type="number"name="blockEndX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">起始Y</span><input class="info-input-num"type="number"name="blockY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束Y</span><input class="info-input-num"type="number"name="blockEndY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">起始角度(°)</span><input class="info-input-num"type="number"name="blockRotate"value="0"step="0.1"></span><span class="info-form"><span class="info-name">结束角度(°)</span><input class="info-input-num"type="number"name="blockEndRotate"value="0"step="0.1"></span><span class="info-form"><span class="info-name">不透明度(0最低,1最高)</span><input class="info-input-num"type="number"name="blockAlpha"value="1"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">结束透明度(0最低,1最高)</span><input class="info-input-num"type="number"name="blockEndAlpha"value="1"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">起始长度</span><input class="info-input-num"type="number"name="blockWidth"value="0"step="0.1"></span><span class="info-form"><span class="info-name">结束长度</span><input class="info-input-num"type="number"name="blockEndWidth"value="0"step="0.1"></span><span class="info-form"><span class="info-name">颜色</span><input class="info-input-col"type="color"name="blockColor"value="rgb(255,255,255)"></span><span class="info-form"><span class="info-name">结束颜色</span><input class="info-input-col"type="color"name="blockEndColor"value="rgb(255,255,255)"></span><span class="info-form"><span class="info-name">开始时间</span><input class="info-input-num"type="number"name="blockStartTime"value="0"step="0.01"></span><span class="info-form"><span class="info-name">结束时间</span><input class="info-input-num"type="number"name="blockEndTime"value="0"step="0.01"></span><span class="info-form"><span class="info-name">贝塞尔曲线动画</span><input class="info-input-che"type="checkbox"name="blockBezier"></span></div><div class="info info-block info-block-bezier"><span class="info-form"><span class="info-name">贝塞尔曲线参数X1</span><input class="info-input-num"type="number"name="blockBezier-x1"value="0"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数Y1</span><input class="info-input-num"type="number"name="blockBezier-y1"value="0"step="0.01"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数X2</span><input class="info-input-num"type="number"name="blockBezier-x2"value="0"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">贝塞尔曲线参数Y2</span><input class="info-input-num"type="number"name="blockBezier-y2"value="0"step="0.01"></span></div><!--text--><div class="info info-text"><span class="info-form"><span class="info-name">文本</span><input class="info-input-num"type="number"name="textId"min="0"value="0"step="1"></span></div><div class="info info-text"><span class="info-form"><span class="info-name">X</span><input class="info-input-num"type="number"name="textX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">Y</span><input class="info-input-num"type="number"name="textY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">rotate</span><input class="info-input-num"type="number"name="textRotate"value="0"step="0.1"></span><span class="info-form"><span class="info-name">不透明度(0最低,1最高)</span><input class="info-input-num"type="number"name="textAlpha"value="1"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">color</span><input class="info-input-col"type="color"name="textColor"value="rgb(255,255,255)"></span></div><!--point--><div class="info info-point"><span class="info-form"><span class="info-name">point</span><input class="info-input-num"type="number"name="pointId"min="0"value="0"step="1"></span><span class="info-form"><span class="info-name">graphic</span><input class="info-input-num"type="number"name="graphicId"min="0"value="0"step="1"></span></div><div class="info info-point"><span class="info-form"><span class="info-name">X</span><input class="info-input-num"type="number"name="pointX"value="0"step="0.01"></span><span class="info-form"><span class="info-name">Y</span><input class="info-input-num"type="number"name="pointY"value="0"step="0.01"></span><span class="info-form"><span class="info-name">rotate</span><input class="info-input-num"type="number"name="pointRotate"value="0"step="0.1"></span><span class="info-form"><span class="info-name">不透明度(0最低,1最高)</span><input class="info-input-num"type="number"name="pointAlpha"value="1"step="0.01"min="0"max="1"></span><span class="info-form"><span class="info-name">color</span><input class="info-input-col"type="color"name="pointColor"value="rgb(255,255,255)"></span></div></div><div id="ui-edit-display">◹</div></div><div id="ui-info"></div><span id="ui-canvas"><canvas id="canvas"preload="auto">您的浏览器不支持HTML5 canvas标签.</canvas></span></div><div id="infos"></div><div id="effects"></div><div id="blur"></div><img id="bg"/>`);
